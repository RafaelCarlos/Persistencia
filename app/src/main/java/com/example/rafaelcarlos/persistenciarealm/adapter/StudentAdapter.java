 ...
 */
public class StudentAdapter extends RealmBaseAdapter<Discipline> {


    public StudentAdapter(Context context, RealmResults<Discipline> realmResults, boolean automaticUpdate) {
